...
const animationUrl = 'https://api.themoviedb.org/3/discover/movie?api_key=1b7c076a0e4849aeefd1f3c429c99a36&with_genres=16';
const animationBody = document.querySelector('.movie-animation-body');
...
form.addEventListener("submit",(s)=>{
    ...
    if(inputValue !== ''){
        movieAnimationAPI(searchAPIQuery + inputValue);
...
mobileForm.addEventListener("submit",(t)=>{
       ...
       if(mobileValue !== ''){
        movieAnimationAPI(searchAPIQuery + mobileValue);
...
navINput.classList.add("input-active");